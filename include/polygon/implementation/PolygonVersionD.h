...
#ifndef POLYGON_VERSION_D_H_INCLUDED
#define POLYGON_VERSION_D_H_INCLUDED

#include "polygon/implementation/SpanExtents.h"

//! Version D of the polygon filler. Similar to C, but uses mask tracking.
class PolygonVersionD : public PolygonFiller
{
public:
...
#endif // !POLYGON_VERSION_D_H_INCLUDED
