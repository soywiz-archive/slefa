 ...
 *
 * \brief NonZeroMaskC is a class for tracking the mask data of non-zero winding buffer.
 *
 *
 * $Id: $
 * $Date: $
...
#ifndef NON_ZERO_MASK_C_H_INCLUDED
#define NON_ZERO_MASK_C_H_INCLUDED
...
#endif // !NON_ZERO_MASK_C_H_INCLUDED
