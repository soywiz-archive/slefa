 ...
 *
 * \brief NonZeroMask is used for tracking the mask data of non-zero winding buffer.
 *
 *
 * $Id: $
 * $Date: $
...
#ifndef NON_ZERO_MASK_H_INCLUDED
#define NON_ZERO_MASK_H_INCLUDED
...
#endif // !NON_ZERO_MASK_H_INCLUDED
