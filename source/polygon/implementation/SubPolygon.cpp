...
bool SubPolygon::verifyEdge(const PolygonEdge &aEdge, const ClipRectangle &aClipRectangle) const
{
...
//! A debug routine for checking that generated edge is valid.
bool SubPolygon::verifyEdge(const PolygonScanEdge &aEdge, const ClipRectangle &aClipRectangle) const
{
    if (aEdge.mFirstLine < (int)aClipRectangle.getMinYi())
        return false;
